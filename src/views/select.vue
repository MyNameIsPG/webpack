<template>
  <div>
    ...
    <baseLayout title="可清空单选" subTitle="包含清空按钮，可将选择器清空为初始状态"></baseLayout>
    <baseLayout title="基础多选" subTitle="适用性较广的基础多选，用 Tag 展示已选项"></baseLayout>
    <baseLayout title="自定义模板" subTitle="可以自定义备选项"></baseLayout>
    <baseLayout title="分组" subTitle="备选项进行分组展示"></baseLayout>
    <baseLayout title="可搜索" subTitle="可以利用搜索功能快速查找选项"></baseLayout>
    <baseLayout title="远程搜索" subTitle="从服务器搜索数据，输入关键字进行查找"></baseLayout>
    <baseLayout title="创建条目" subTitle="可以创建并选中选项中不存在的条目"></baseLayout>
  </div>
</template>
